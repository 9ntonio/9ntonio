				...
				<div className="container">
					...
					<div className="row">
						<p className="font-18 mb-3">
							...
							I'm currently part of the team over @ <Link to="https://www.assurely.com/" target="_blank" rel="noreferrer noopener">Assurely</Link> and I live in the <Link to="https://www.thrillist.com/events/san-francisco/things-to-do-in-san-francisco-sf-this-weekend" target="_blank" rel="noreferrer noopener">San Francisco</Link>.
						</p>
					</div>
