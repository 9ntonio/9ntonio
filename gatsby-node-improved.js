...
exports.onPreBuild = ({ reporter }) => {
	...
	// Copy main directory
	const mainCopySuccess = safeCopyDirectory(sourceDir, publicDir, reporter, "unknown-pleasures directory");

	// Copy assets directory
	const assetsCopySuccess = safeCopyDirectory(sourceAssetsDir, publicAssetsDir, reporter, "assets directory");
