...
((e) => {
	const t = () => {},
		...
		i = (e) => !(s(e, "webkit") || s(e, "toJSON") || s(e, "constructor") || s(e, "toString") || s(e, "_")),
	...
	const $ = e.parent,
		...
		I = (e, t, r, s, o, a, l, c) => {
			if (((a = {}), !r.has(t)))
				for (l in (r.add(t), t)) i(l) && ((c = "path" === l && n(t).endsWith("Event") ? t.composedPath() : t[l]), (s || "function" != typeof c) && (o || "" !== c) && (a[l] = C(e, c, r)));
			return a;
		},
		M = (e) => {
			let t,
		...
		x = (t, r, n, s) =>
			r
				? ((n = r[0]),
					(s = r[1]),
					0 === n ? s : 4 === n ? L(t, s) : 1 === n ? s.map((e) => x(t, e)) : 3 === n ? y(s[0], s[1]) : 5 === n ? R(A(t, s)) : 2 === n ? A(t, s) : 8 === n ? s : 9 === n ? new e[r[2]](s) : void 0)
				: void 0,
		L = (e, { V: t, w: r, L: n }, s) => (
			(s = p.get(n)) ||
				((s = function (...s) {
		...
		H = (e, t) => {
			...
			l && l.body
				? ((n = l.querySelector('script[type="text/partytown"]:not([data-ptid]):not([data-pterror]):not([async]):not([defer])')),
					...
					n
						? ((n.dataset.ptid = s = f(n, o)), (i = { V: o, w: s }), n.src ? ((i.S = n.src), (i.H = n.dataset.ptsrc || n.src)) : (i.j = n.innerHTML), e.postMessage([7, i]))
						: (t.x ||
								((t.x = 1),
								((e, t, n) => {
									let s,
									...
									if (
										...
										a.map((e) => {
											(i = n),
												e.split(".").map((e, t, n) => {
													i = i[n[t]] = t + 1 < r(n) ? i[n[t]] || ("push" === n[t + 1] ? [] : {}) : (...e) => l(n, e);
												});
										}),
										o)
									)
				...
				.map((e) =>
					((e, t, r, n) => {
						if ((r = t.match(/^(HTML|SVG)(.+)Element$/)))
							return (n = r[2]), "S" == t[0] ? e.createElementNS("http://www.w3.org/2000/svg", c[n] || n.slice(0, 2).toLowerCase() + n.slice(2)) : e.createElement(l[n] || n);
					})(S, e),
				)
				.filter((e) => e)
				.map((e) => [e]);
			...
			if (0 === i) {
				const e = (() => {
					const e = S.createElement("i"),
						...
						h = [F("Window", $), F("Node", t)],
						d = {
							i: JSON.stringify(b, (e, t) => ("function" == typeof t && (t = String(t)).startsWith(e + "(") && (t = "function " + t), t)),
							v: B(u, h),
								...
								4 === t[0]
									...
									: (r = m[t[1]]) &&
										(7 === t[0]
											...
											: 6 === t[0] &&
												((e, t, r, n, s) => {
													(s = t.U.document.querySelector(`[data-ptid="${r}"]`)) && (n ? (s.dataset.pterror = n) : (s.type += "-x"), delete s.dataset.ptid), H(e, t);
												})(e, r, t[2], t[3]));
							})(n, s);
		};
