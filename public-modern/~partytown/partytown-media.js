									...
									? "function" == typeof p[t]
										? (...e) => {
												if (t.startsWith("create")) {
													const r = a();
													return (
														n(f, [t], e, 2, r), "createImageData" === t || "createPattern" === t ? ((s = `${t}()`), console.warn(`${s} not implemented`), { setTransform: () => {} }) : new h(i, r)
													);
												}
												var s;
										...
										: p[t]
									: e[t],
							set: (e, t, n) => ("string" == typeof t && t in p ? (p[t] !== n && "function" != typeof n && s(f, [t], n), (p[t] = n)) : (e[t] = n), !0),
						};
				...
				g = (e, t, r) => {
					const i = e[o],
						...
						p = {
							...
							set: (e, t, n) => ("string" == typeof t && t in f ? (f[t] !== n && "function" != typeof n && s(h, [t], n), (f[t] = n)) : (e[t] = n), !0),
						};
