...
((self) => {
	...
	const getConstructorName = (obj) => {
		...
		try {
			const zoneJsConstructorName =
				null === (_c = null === (_b = null == obj ? void 0 : obj.__zone_symbol__originalInstance) || void 0 === _b ? void 0 : _b.constructor) || void 0 === _c ? void 0 : _c.name;
	...
	const getInstanceCacheKey = (instance, memberName, args) =>
		[instance[WinIdKey], instance[InstanceIdKey], memberName, ...(args || EMPTY_ARRAY).map((arg) => String(arg && arg[WinIdKey] ? arg[InstanceIdKey] : arg))].join(".");
						...
						if (scriptContent) {
							if (isScriptJsType(scriptType)) {
								...
								const loadOnMainThread =
									scriptId && (null === (_b = null === (_a = config.loadScriptsOnMainThread) || void 0 === _a ? void 0 : _a.includes) || void 0 === _b ? void 0 : _b.call(_a, scriptId));
								if (loadOnMainThread) {
						...
						try {
							...
							if (rsp.ok) {
								...
								let shouldExecute = javascriptContentTypes.some((ct) => {
									var _a, _b, _c;
									return null ===
										(_c = null === (_a = null == responseContentType ? void 0 : responseContentType.toLowerCase) || void 0 === _a ? void 0 : (_b = _a.call(responseContentType)).includes) ||
										void 0 === _c
										? void 0
										: _c.call(_b, ct);
								});
