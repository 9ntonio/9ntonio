/*! For license information please see b9209e23ca9cdcfd6bd2bfa1c552ecade4562769-2306030fbc185defea22.js.LICENSE.txt */
"use strict";
(self.webpackChunkantonio_almena_portfolio = self.webpackChunkantonio_almena_portfolio || []).push([
	[830],
	{
		5404: function (t, e, n) {
			n(4751), n(6371), n(4559), n(5510), n(4644), n(9086), n(1612), n(9802), n(7538), n(1974), n(9991), n(9795), n(2401), n(6288), n(1677);
			var r = n(3746),
				o = n(5983),
				a = n.n(o),
				i = n(4529),
			...
			function f(t) {
				var e,
					...
					m = void 0 === d ? [] : d,
					p = t.Sitetitle,
					h = void 0 === p ? "Antonio Almena" : p,
					y = (0, i.useStaticQuery)("3537562275").site,
					v = s || (null === (e = y.siteMetadata) || void 0 === e ? void 0 : e.description) || "",
					g = (null === (n = y.siteMetadata) || void 0 === n ? void 0 : n.title) || "Design Technologist",
					w = (null === (o = y.siteMetadata) || void 0 === o ? void 0 : o.siteUrl) || "",
					b = (null === (a = y.siteMetadata) || void 0 === a ? void 0 : a.image) || "/social.jpg",
					k = (null === (l = y.siteMetadata) || void 0 === l ? void 0 : l.author) || "@9ntonio",
					L = "".concat(h, " | ").concat(g),
					x = r.useMemo(
						function () {
							return [
								{ name: "description", content: v },
								...
								{ property: "og:url", content: w },
								{ property: "og:title", content: L },
								{ property: "og:description", content: v },
								{ property: "og:image", content: "".concat(w).concat(b) },
								{ name: "twitter:card", content: "summary_large_image" },
								{ name: "twitter:creator", content: k },
								{ name: "twitter:title", content: L },
								{ name: "twitter:description", content: v },
								{ name: "twitter:image", content: "".concat(w).concat(b) },
							].filter(function (t) {
								return t.content;
							});
						},
					...
					E = r.useMemo(
						function () {
							var t = Array.isArray(m)
								...
								: [];
							return [].concat(u(x), u(t));
						},
						[x, m],
					);
				return (0, c.jsxs)(c.Fragment, {
					children: [
						(0, c.jsx)("title", { children: L }),
						(0, c.jsx)("html", { lang: "en" }),
						E.map(function (t, e) {
							if (!t || !t.content) return null;
							var n = "".concat(t.name || t.property, "-").concat(e);
							return t.name ? (0, c.jsx)("meta", { name: t.name, content: t.content }, n) : t.property ? (0, c.jsx)("meta", { property: t.property, content: t.content }, n) : null;
						}),
					],
				});
			}
			(f.propTypes = { description: a().string, meta: a().arrayOf(a().shape({ name: a().string, content: a().string.isRequired, property: a().string })), Sitetitle: a().string }), (e.A = f);
		},
		7219: function (t, e, n) {
			n(4751), n(6371), n(4559), n(1612), n(3726), n(7538), n(1974), n(327), n(9991), n(1814), n(6288), n(16), n(1677);
			var r = n(3746);
			function o(t) {
				return (
					(o =
			...
			function a() {
				...
				var x = Object.getPrototypeOf,
					E = x && x(x(I([])));
				E && E !== n && r.call(E, u) && (L = E);
				var j = (k.prototype = w.prototype = Object.create(L));
				function _(t) {
				...
				function A(e, n, r) {
					...
					return function (a, i) {
						...
						for (r.method = a, r.arg = i; ; ) {
							...
							var l = m(e, n, r);
							if ("normal" === l.type) {
								if (((o = r.done ? v : h), l.arg === g)) continue;
				...
				function O(e, n) {
					...
					var a = m(o, e.iterator, n.arg);
					if ("throw" === a.type) return (n.method = "throw"), (n.arg = a.arg), (n.delegate = null), g;
					var i = a.arg;
					return i
						? i.done
							? ((n[e.resultName] = i.value), (n.next = e.nextLoc), "return" !== n.method && ((n.method = "next"), (n.arg = t)), (n.delegate = null), g)
							: i
				...
				return (
					(b.prototype = k),
					i(j, "constructor", { value: k, configurable: !0 }),
					i(k, "constructor", { value: b, configurable: !0 }),
					(b.displayName = s(k, f, "GeneratorFunction")),
					(e.isGeneratorFunction = function (t) {
						var e = "function" == typeof t && t.constructor;
						return !!e && (e === b || "GeneratorFunction" === (e.displayName || e.name));
					}),
					(e.mark = function (t) {
						return Object.setPrototypeOf ? Object.setPrototypeOf(t, k) : ((t.__proto__ = k), s(t, f, "GeneratorFunction")), (t.prototype = Object.create(j)), t;
					}),
					(e.awrap = function (t) {
						return { __await: t };
					}),
					...
					(P.prototype = {
						...
						abrupt: function (t, e) {
							...
							return (i.type = t), (i.arg = e), a ? ((this.method = "next"), (this.next = a.finallyLoc), g) : this.complete(i);
						},
						...
						delegateYield: function (e, n, r) {
							return (this.delegate = { iterator: I(e), resultName: n, nextLoc: r }), "next" === this.method && (this.arg = t), g;
						},
					}),
					e
				);
													...
													for (;;)
														switch ((t.prev = t.next)) {
															...
															case 3:
																(t.prev = 3),
																	(n = t.catch(0)),
																	console.warn("Font loading failed, using fallbacks:", n),
																	document.documentElement.classList.remove("font-loading"),
...
//# sourceMappingURL=b9209e23ca9cdcfd6bd2bfa1c552ecade4562769-2306030fbc185defea22.js.map
